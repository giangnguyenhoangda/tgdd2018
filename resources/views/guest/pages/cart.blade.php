											...
											<table cellspacing="0" class="shop_table shop_table_responsive">
												...
												<tr class="shipping">
														...
														<td data-title="Giao hàng 1">
															...
															<form class="woocommerce-shipping-calculator" action="http://localhost/TGDD/gio-hang/" method="post">
																...
																<section class="shipping-calculator-form" style="display:none;">
																	...
																	<input type="hidden" id="_wpnonce1" name="_wpnonce1" value="263b818ada" /><input type="hidden" name="_wp_http_referer" value="/TGDD/gio-hang/" />	
																</section>
															</form>
														</td>
													</tr>						
													<tr class="order-total">
														<th>Tổng cộng</th>
														<td data-title="Tổng cộng"><strong><span class="woocommerce-Price-amount amount">{{ $cart->totalPrice }}<span class="woocommerce-Price-currencySymbol">&#8363;</span></span></strong> </td>
													</tr>		
												</table>
												<div class="wc-proceed-to-checkout">		
													<a href="{{ route('getHome') }}" class="checkout-button button alt wc-forward">Tiến hành thanh toán</a>
												</div>	
											</div>
