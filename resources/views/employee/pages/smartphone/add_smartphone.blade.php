...
@section('content')
	<div class="panel panel-white">
		...
		<form class="steps-validation" method="post" action="{{ route('postAddSmartPhone') }}" enctype="multipart/form-data" id="addSmartphone">
			<h6>Bước 1</h6>
			<fieldset>
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
		                    ...
		                    <input type="hidden" id="c" sw_title="Nhắc nhở" sw_contnet="Bạn muốn thêm điện thoại?" sw_notice="Thêm thành công" sw_form_id="addSmartphone">
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="productName" class="form-control required" placeholder="Samsung Note 9">
						</div>
					</div>
