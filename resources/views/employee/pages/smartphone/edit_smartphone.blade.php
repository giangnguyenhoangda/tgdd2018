...
@section('content')
	<div class="panel panel-white">
		<div class="panel-heading">
			<h6 class="panel-title">Điện Thoại</h6>
		...
		<form class="steps-validation" method="post" action="{{ route('postEditSmartPhone') }}" enctype="multipart/form-data" id="editSmartphone">
			<h6>Bước 1</h6>
			<fieldset>
				<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="hidden" id="c" sw_title="Nhắc nhở" sw_contnet="Bạn muốn sửa thông tin điện thoại?" sw_notice="Sửa thông tin thành công" sw_form_id="editSmartphone">
											...
											<select name="productType" data-placeholder="Chọn hãng sản xuất" class="select required">
												<option></option>
													<option value="iphone" @if ($product['productType']=='iphone')
														selected 
													@endif>Iphone</option>
													<option value="samsung" @if ($product['productType']=='samsung')
														selected 
													@endif>Samsung</option>
													<option value="lg" @if ($product['productType']=='lg')
														selected 
													@endif>Lg</option>
									...
									<div class="col-md-6">
										<div class="form-group">
											<label>Tên Điện Thoại: <span class="text-danger">*</span></label>
							...
							<fieldset>
								...
								<div class="row">
									...
									<div class="col-md-6">
										...
										<div class="form-group">
											<label>Số Sim:</label>
			                                <input type="number" name="sim" placeholder="2" class="form-control" value="{{ $smartphone['sim'] }}">
		                                </div>
									</div>
								</div>
							</fieldset>
